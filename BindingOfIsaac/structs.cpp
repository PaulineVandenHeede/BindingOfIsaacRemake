...
Rectf::Rectf(Point2f leftBottom, float width, float height)
	: Rectf{ leftBottom.x, leftBottom.y, width, height }
{
}
...
//-----------------------------------------------------------------
// Offset2f Constructors
//-----------------------------------------------------------------
Offset2f::Offset2f()
	:Offset2f{ 0.0f, 0.0f }
{
}
Offset2f::Offset2f(float x, float y)
	: x{ x }, y{ y }
{
}
