...
void Core::Run( )
{
	...
	// Create the ScreenFlow object
	ScreenFlow screenFlow{ m_Window };
	...
	while ( !quit )
	{
		...
		while ( SDL_PollEvent( &e ) != 0 )
		{
			...
			case SDL_QUIT:
				...
				break;
			case SDL_KEYDOWN:
				screenFlow.ProcessKeyDownEvent( e.key );
				break;
			case SDL_KEYUP:
				screenFlow.ProcessKeyUpEvent( e.key, quit );
				break;
			case SDL_MOUSEMOTION:
				screenFlow.ProcessMouseMotionEvent( e.motion );
				break;
			case SDL_MOUSEBUTTONDOWN:
				screenFlow.ProcessMouseDownEvent( e.button );
				break;
			case SDL_MOUSEBUTTONUP:
				screenFlow.ProcessMouseUpEvent( e.button );
				break;
			}
		}
		...
		if ( !quit )
		{
			...
			screenFlow.Update(elapsedSeconds);
